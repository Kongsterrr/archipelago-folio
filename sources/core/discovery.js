...
export class DiscoveryStore {
  constructor({storage, defaults={}, onChange=()=>{}}={}) {
    ...
    const saved=this.read('jack-archipelago-v2'), old=this.read('jack-archipelago-v1');
  ...
  save(){try{this.storage?.setItem('jack-archipelago-v2',JSON.stringify({version:2,settings:this.settings,discovered:[...this.discovered],visited:[...this.visited],viewed:[...this.viewed],secrets:[...this.secrets],completed:[...this.completed],bests:this.bests}));}catch{/* The in-memory voyage remains usable. */}}
