...
const loader=new GLTFLoader().setMeshoptDecoder(MeshoptDecoder),gltf=await loader.loadAsync(kind==='jack'&&!params.has('legacy')?JACK_ASSET_URL:`/models/${kind}.glb?v=${kind==='jack'?8:7}`),surfaces=new SurfaceLibrary({renderer});
