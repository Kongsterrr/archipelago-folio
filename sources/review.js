...
for(let index=0;index<3;index++){
 ...
 const camera=new THREE.PerspectiveCamera(28,1,.01,1000);const directions=kind==='jack'?[new THREE.Vector3(0,.02,-1),new THREE.Vector3(.7,.13,-1),new THREE.Vector3(1,.02,-.04)]:[new THREE.Vector3(0,.8,-1),new THREE.Vector3(.8,.8,-1),new THREE.Vector3(1,.6,0)];
