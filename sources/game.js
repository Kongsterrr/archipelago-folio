...
export class Game {
 ...
 reset(){this.boarding?.cancel();if(this.player?.walking){this.character.teleport(this.player.berth.landing);this.player.pauseReasons.clear();this.mode='exploring';this.focus=null;this.inputs.setEnabled(true);this.resetCamera();return this.player.island;}const i=nearestIsland(this.boat.position);this.teleport({...i.dock,yaw:i.yaw});return i;}
